...
//     .await
//     .ok_or_else(|| {
//         AppError::AdapterCreationError("Failed to request adapter".to_string())
//     })?;
...
//                 // Each worker thread records commands
//                 s.spawn(move |_| {
//                     let command_encoder =
...
//                     // Recording GPU commands happens here...
...
//             // Submission thread waits for command encoders to be received and submits them
...
//     /// Function to add a command buffer for execution
...
//     // Record commands (e.g., drawing, compute tasks) using encoder...
