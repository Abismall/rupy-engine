...
LOGGING_METHOD_OPTIONS = ["file", "console"]

# ========================
# ERROR MESSAGES
# ========================
UNKNOWN_ERROR_STATUS = "[UnknownError]"
IMPORT_ERROR_STATUS = "[ImportError]"
TYPE_ERROR_STATUS = "[TypeError]"
VALUE_ERROR_STATUS = "[ValueError]"
UNBOUND_LOCAL_ERROR_STATUS = "[UnboundLocalError]"
ARGUMENT_ERROR_STATUS = "[ArgumentError]"
RUNTIME_ERROR_STATUS = "[RuntimeError]"
CHILD_PROCESS_ERROR_STATUS = "[ChildProcessError]"

UNKNOWN_ERROR_MSG = "An unexpected error occurred. Please try again."
IMPORT_ERROR_MSG = "Failed to import the required module: {details}."
TYPE_ERROR_MSG = "Type mismatch encountered: {details}."
VALUE_ERROR_MSG = "Invalid value provided: {details}."
UNBOUND_LOCAL_ERROR_MSG = "Referenced a variable before assignment: {details}."
ARGUMENT_ERROR_MSG = "Invalid arguments supplied: {details}."
RUNTIME_ERROR_MSG = "A runtime error has occurred: {details}."
CHILD_PROCESS_ERROR_MSG = "Error in child process execution: {details}."

ERROR_MESSAGE_TEMPLATE = "{status} - {message}"
